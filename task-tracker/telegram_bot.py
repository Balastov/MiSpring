...
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if context.args:
        ...
        await update.message.reply_text(
            ...
            f"1. Зайдите на сайт mispring7ru\n" # Менять сайт здесь, если он будет другим
            f"2. Откройте Настройки → Telegram\n"
            f"3. Нажмите 'Сгенерировать код'\n"
            f"4. Отправьте мне команду: `/start КОД` (вместо КОД впишите тот код, который вам выдал сайт. Например, сайт предложил код ABC123, напишите боту /start ABC123)\n\n"
            f"**Доступные команды:**\n"
            f"/help - Помощь\n"
